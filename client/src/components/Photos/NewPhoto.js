        ...
        <div className=''>
            {photoReady.ready ?
                ...
                <div className='w-60 h-60 rounded-rounded grow-0 shrink-0'>
                    ...
                    <img  id={profilePhoto.id} className="h-60 w-60 object-cover rounded-rounded shadow-md m-0" src={profilePhoto.urls_small} alt={profilePhoto.alt_description} />
                    {/* FEATURE : GET ALL USERS THAT USE THIS PROFILE PHOTO */}
                    {/* <Link className='btn btn-secondary' to={`/user/${user._id}`}>View Users</Link> */}
                </div>
                :
                <div className='animate-pulse w-1/2 h-20 rounded-rounded grow-0 shrink-0'>
                    <div className=" bg-gray-300 h-60 w-60 object-cover rounded-rounded shadow-md m-0">                        
                    </div>
                </div>
            }
        </div>
